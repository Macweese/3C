 ...
 * @Created 06:12 Tue 02 June 2026
 * @Project 3C: Competitive Coding Challenges
 **/
@DisplayName("3633. Earliest Finish Time for Land and Water Rides I")
class EarliestFinishTimeForLandAndWaterRidesITest
{
	...
	void earliestFinishTime()
	{
		for (Map.Entry<Input, Integer> entry : MAP.entrySet())
		{
			...
			final int actual = EarliestFinishTimeForLandAndWaterRidesI.earliestFinishTime(landStartTime, landDuration, waterStartTime, waterDuration);
