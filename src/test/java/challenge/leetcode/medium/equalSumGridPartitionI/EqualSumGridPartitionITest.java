...
package challenge.leetcode.medium.equalSumGridPartitionI;
 ...
 * @Created 06:40 Wed 25 March 2026
 * @Project 3C: Competitive Coding Challenges
 **/
@DisplayName("3546. Equal Sum Grid Partition I")
class EqualSumGridPartitionITest
{
	...
	void canPartitionGrid()
	{
		for (Map.Entry<int[][], Boolean> entry : MAP.entrySet())
		{
			...
			final boolean actual = EqualSumGridPartitionI.canPartitionGrid(input);
