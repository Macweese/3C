...
[LeetCode 2536](https://leetcode.com/problems/increment-submatrices-by-one/)
...
</ul><p>Return<em> the matrix</em> <code>mat</code><em> after performing every query.</em></p>
...
**POTD** `2025-11-14, Fri 14 November 2025`
