...
[LeetCode 3753](https://leetcode.com/problems/total-waviness-of-numbers-in-range-ii/)

## Description

<p>You are given two integers <code>num1</code> and <code>num2</code> representing an <strong>inclusive</strong> range <code>[num1, num2]</code>.</p><p>The <strong>waviness</strong> of a number is defined as the total count of its <strong>peaks</strong> and <strong>valleys</strong>:</p><ul>
...
<span class="example-io">num1 = 120, num2 = 130</span>
</pre>
...
<b>Explanation:</b>
<pre style="margin-left: 40px">
<p>In the range <code>[120, 130]</code>:</p><ul>
...
</ul><p>Thus, total waviness is <code>1 + 1 + 1 = 3</code>.</p>
</pre>
...
<b>Input:</b>
<pre style="margin-left: 40px">
<span class="example-io">num1 = 198, num2 = 202</span>
</pre>
...
<b>Explanation:</b>
<pre style="margin-left: 40px">
<p>In the range <code>[198, 202]</code>:</p><ul>
...
<b>Input:</b>
<pre style="margin-left: 40px">
<span class="example-io">num1 = 4848, num2 = 4848</span>
</pre>
