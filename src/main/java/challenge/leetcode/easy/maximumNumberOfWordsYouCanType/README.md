...
[LeetCode 1935](https://leetcode.com/problems/maximum-number-of-words-you-can-type/)
...
<b>Input:</b>  `text = "hello world"`, `brokenLetters = "ad"`

<b>Output:</b>  `1`

<b>Explanation:</b> We cannot type `"world"` because the `'d'` key is broken.
...
<b>Input:</b>  `text = "leet code"`, `brokenLetters = "lt"`

<b>Output:</b>  `1`

<b>Explanation:</b> We cannot type `"leet"` because the `'l'` and `'t'` keys are broken.
...
<b>Input:</b>  `text = "leet code"`, `brokenLetters = "e"`

<b>Output:</b>  `0`

<b>Explanation:</b> We cannot type `"leet"`, `"code"` because the `'e'` key is broken. 
...
- <code>1 &le; text.length &le; 10<sup>4</sup></code>
- <code>0 &le; brokenLetters.length &le; 26</code>
