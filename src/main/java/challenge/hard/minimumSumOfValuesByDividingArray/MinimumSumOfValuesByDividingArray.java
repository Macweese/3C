 ...
 */
package challenge.hard.minimumSumOfValuesByDividingArray;
 ...
 * {@link challenge.hard.minimumCostToSplitAnArray.MinimumCostToSplitAnArray 2547. Minimum Cost to Split an Array (local)}<br>
 * {@link challenge.hard.findSubarrayWithBitwiseORClosestToK.FindSubarrayWithBitwiseORClosestToK 3171. Find Subarray With Bitwise OR Closest to K (local)}<br>
